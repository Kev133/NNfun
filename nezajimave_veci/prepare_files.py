...
starting_point = 200
ending_point = 20000
number_of_files_for_one_MC_num = 10
hundreds = np.arange(starting_point,1000,100) # start, end, step
...
i=1
for number in list:
    default_values.update({"num_particles_mc_simulation":number})
